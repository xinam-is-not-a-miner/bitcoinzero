...
//    const bool fPreSegWit = (THRESHOLD_ACTIVE != VersionBitsState(pindexPrev, consensusParams, Consensus::DEPLOYMENT_SEGWIT, versionbitscache));
    ...
    result.push_back(Pair("bznode_payments_started", sporkManager.IsSporkActive(SPORK_8_PAY_NODES)));
    result.push_back(Pair("bznode_payments_enforced", sporkManager.IsSporkActive(SPORK_7_FEE_CHECKS)));
